...
const (
	filename      = `../../../.github_original/labeler-pr-triage.yml`
...
create:
  - 'internal/create/**/*'
dependencies:
  - '.github_original/dependabot.yml'
documentation:
  - '**/*.md'
  - 'docs/**/*'
  - 'website/**/*'
...
github_actions:
  - '.github_original/*.yml'
  - '.github_original/workflows/*.yml'
linter:
  - '.ci_original/**/*'
  - '.github_original/workflows/acctest-terraform-lint.yml'
  - '.github_original/workflows/providerlint.yml'
  - '.github_original/workflows/semgrep-ci.yml'
  - '.github_original/workflows/terraform_provider.yml'
  - '.github_original/workflows/website.yml'
  - '.github_original/workflows/workflow-lint.yml'
